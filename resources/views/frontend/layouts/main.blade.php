...
<body>
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link {{ (isset($key) && $key == 'beranda') ? 'active' : '' }}"
                            href="{{ route('frontend.public.beranda') }}">
                            Beranda
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ (isset($key) && $key == 'tentang') ? 'active' : '' }}"
                            href="{{ route('frontend.public.tentang') }}">
                            Tentang Kami
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ (Request::is('produk*')) ? 'active' : '' }}"
                            href="{{ route('frontend.public.produk') }}">
                            Produk
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ (isset($key) && $key == 'artikel') ? 'active' : '' }}"
                            href="{{ route('frontend.public.artikel') }}">
                            Artikel
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ (isset($key) && $key == 'kontak') ? 'active' : '' }}"
                            href="{{ route('frontend.public.kontak') }}">
                            Kontak
                        </a>
                    </li>
                </ul>
    ...
    <footer>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-5 mb-lg-0">
                    ...
                    <div class="social-links">
                        ...
                        <a href="https://wa.me/6285600773008" target="_blank" class="social-icon"><i class="fab fa-whatsapp"></i></a>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
                    ...
                    <ul class="footer-list">
                        <li>
                            <a href="{{ route('frontend.public.jualbeli') }}" class="footer-link">Jual Beli</a>
                        </li>
                        <li>
                            <a href="{{ route('frontend.public.service') }}" class="footer-link">Servis</a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="social-links social-links-mobile justify-content-center mb-3">
            <a href="#" class="social-icon"><i class="fab fa-facebook-f"></i></a>
            <a href="https://www.instagram.com/omahebrankassemarang?igsh=MWF6aDhhaWJnZjhjbQ==" target="_blank" class="social-icon"><i
