                ...
                <div class="col-lg-4 col-md-6">
                    <div class="article-card">
                        ...
                        <div class="article-body">
                            ...
                            <a href="{{ route('frontend.artikel.detail', 'tips-memilih-brankas') }}"
                                class="btn-read-more">Selengkapnya <i class="fas fa-arrow-right ml-1"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="article-card">
                        ...
                        <div class="article-body">
                            ...
                            <a href="{{ route('frontend.artikel.detail', 'standar-tahan-api') }}"
                                class="btn-read-more">Selengkapnya <i class="fas fa-arrow-right ml-1"></i></a>
                        </div>
                    </div>
                </div>
